...
　　var Moghunter = Moghunter || {}; 
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_SceneMenu');
    ...
    Moghunter.scMenu_MagicCircleX = Number(Moghunter.parameters['Magic Circle X-Axis'] || 1000);
	 ...
	 for (var i = 0; i < this._comList.length; i++) {
		 ...
		 switch(1){
			case 1:
				...
				break;
			case 2:
				this._compos[i] = [Moghunter.scMenu_ComX + (48 * i),Moghunter.scMenu_ComY];
				break;
			case 3:
				this._compos[i] = [Moghunter.scMenu_ComX ,Moghunter.scMenu_ComY + (48 * i)];
				break;
		 }
		 this._comzoom[i] = 0;
...
MCharStatus.prototype.createLayoutStatus = function() {
	 ...
	 this._layout.x = this.posX() - 100 + Moghunter.scMenu_layoutStatusX;
